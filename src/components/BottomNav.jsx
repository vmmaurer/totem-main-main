...
const GlassFilterDefs = () => (
  ...
  >
    <filter id="bottomNavGlass" primitiveUnits="objectBoundingBox">
...
const Nav = styled.nav`
  ...
  padding: 10px;
  border-radius: 99rem;
  background-color: rgba(0, 82, 245, 0.22);
  backdrop-filter: blur(18px) url(#bottomNavGlass) saturate(180%) contrast(160%);
  -webkit-backdrop-filter: blur(18px) saturate(180%) contrast(160%);
  box-shadow:
    ...
    0px 10px 28px 0px rgba(0, 0, 0, 0.22);
`;
...
const TabButton = styled.button`
  ...
  color: ${({ $active }) => ($active ? '#0052f5' : 'rgba(255, 255, 255, 0.92)')};
